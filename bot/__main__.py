...
def start(update, context):
    ...
    buttons.buildbutton("Contact me", "https://t.me/riyad48")
    buttons.buildbutton("Official Group", "https://t.me/mirror_rtx")
...
'''
        ...
        sendMarkup('Not Authorized user, to get authorization contact @riyad48😎', context.bot, update, reply_markup)
...
help = telegraph.create_page(
        title='Public Mirror Bot Help manual',
